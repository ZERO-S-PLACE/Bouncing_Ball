...
public class ComplexAreaFlowController extends LeftPanelController {
    ...
    private void setButtonsFunctions() {
        sumButton.setOnAction(e -> CreatorModel.getInstance().getLevelCreator().changeComplexAreaAction(ComplexAreaAction.SUM));
        intersectionButton.setOnAction(e -> CreatorModel.getInstance().getLevelCreator().changeComplexAreaAction(ComplexAreaAction.INTERSECTION));
        subtractFromComplexButton.setOnAction(e -> CreatorModel.getInstance().getLevelCreator().changeComplexAreaAction(ComplexAreaAction.SUBTRACTION_A_B));
        subtractComplexButton.setOnAction(e -> CreatorModel.getInstance().getLevelCreator().changeComplexAreaAction(ComplexAreaAction.SUBTRACTION_B_A));
        acceptButton.setOnAction(e -> CreatorModel.getInstance().getLevelCreator().changeComplexAreaAction(ComplexAreaAction.NONE));
