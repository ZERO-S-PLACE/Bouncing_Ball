package org.zeros.bouncy_balls.Applications.GameApplication.Views;
...
public class ViewFactory {
    ...
    public void showMainWindow() {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/GameApplication/MainWindow.fxml"));
    ...
    public BorderPane getLevelTypeChoicePanel() {
        if (levelTypeChoicePanel == null) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/GameApplication/2a_LevelTypeChoice/LevelTypeChoicePanel.fxml"));
    ...
    public BorderPane getLeaderboardPanel() {
        if (leaderboardPanel == null) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/GameApplication/2b_Leaderboard/LeaderboardPanel.fxml"));
    ...
    public BorderPane getSettingsPanel() {
        if (settingsPanel == null) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/GameApplication/2d_Settings/SettingsPanel.fxml"));
    ...
    public BorderPane getLevelSubtypePanel(AnimationType type) {
        if (levelSubtypePanel == null) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/GameApplication/3_LevelSubtypeChoice/LevelSubtypeChoicePanel.fxml"));
    ...
    public BorderPane getNewLevelSelectionPanel(AnimationType type, String subtype) {
        if (levelSelectionPanel == null) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/GameApplication/4_LevelSelection/LevelSelectionPanel.fxml"));
    ...
    public BorderPane getGamePausedPanel() {
        if (gamePausedPanel == null) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/GameApplication/5_AnimationPanel/GamePausedPanel.fxml"));
    ...
    public BorderPane getCountDownPanel() {
        if (gameCountDownPanel == null) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/GameApplication/5_AnimationPanel/GameCountDownPanel.fxml"));
